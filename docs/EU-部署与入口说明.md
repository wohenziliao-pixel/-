...
| 前端构建戳 | 控制台 `[次元姬 EU] client build`，当前 **`20260523-shared-api-cm-sync-v142`**（见 `docs/eu-completions/2026-05-23-004-网络版v142同步指令.md`） |
...
| `docs/eu-completions/2026-05-23-004-网络版v142同步指令.md` | **本次网络版同步（v138～v142 + 共用 API）** |
| `docs/eu-completions/2026-05-22-059-网络版v137同步指令.md` | 历史：v134～v137 |
